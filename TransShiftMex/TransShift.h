...
private:
	...
	struct{
		...
		mytype dRMSThreshTime;          // minimum-time that RMS needs to be above threshhold for voicing detection
		...
		mytype minVowelLen;
        mytype eqfilterinput_a[N_COEFFS_SRFILT];
        mytype eqfilterinput_b[N_COEFFS_SRFILT];
        mytype eqfilteroutput_a[N_COEFFS_SRFILT];
        mytype eqfilteroutput_b[N_COEFFS_SRFILT];
